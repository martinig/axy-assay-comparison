#code to make the coefficient plots from the multivariate models for assay and focal principal components (PC1, PC2, no PC3 at this time)
#across ageclass dataset (n = 88)
#last edited Feb 26, 2021 by A. R. Martinig
...
subject <- c("OFT1:OFT1", "MIS1:OFT1", "PC1:OFT1", "PC2:OFT1", "OFT1:MIS1", "MIS1:MIS1", "PC1:MIS1", "PC2:MIS1", "OFT1:PC1", "MIS1:PC1", "PC1:PC1", "PC2:PC1", "OFT1:PC2", "MIS1:PC2", "PC1:PC2", "PC2:PC2")
...
plot.dat<-plot.dat%>%filter(subject %in% c("OFT1:MIS1", "OFT1:PC1", "OFT1:PC2", "MIS1:PC1", "MIS1:PC2"))

plot.dat$subject2 <- factor(plot.dat$subject2, levels=c("MIS1:PC2", "MIS1:PC1", "OFT1:PC2", "OFT1:PC1", "OFT1:MIS1"))
...
A<-ggplot(plot.dat, 
	...
	scale_y_discrete(breaks = c("OFT1:MIS1", "OFT1:PC1", "OFT1:PC2", "MIS1:PC1", "MIS1:PC2"),
			labels = c("Assay BA1 &\nAssay BA2", "Assay BA1 &\nFocal BA1", "Assay BA1 &\nFocal BA2", "Assay BA2 &\nFocal BA1", "Assay BA2 &\nFocal BA2"),
...
subject3 <- c("OFT1:OFT1", "MIS1:OFT1", "PC1:OFT1", "PC2:OFT1", "OFT1:MIS1", "MIS1:MIS1", "PC1:MIS1", "PC2:MIS1", "OFT1:PC1", "MIS1:PC1", "PC1:PC1", "PC2:PC1", "OFT1:PC2", "MIS1:PC2", "PC1:PC2", "PC2:PC2")
...
plot.dat2<-plot.dat2%>%filter(subject3 %in% c("OFT1:MIS1", "OFT1:PC1", "OFT1:PC2", "MIS1:PC1", "MIS1:PC2"))

plot.dat2$subject4 <- factor(plot.dat2$subject4, levels=c("MIS1:PC2", "MIS1:PC1", "OFT1:PC2", "OFT1:PC1", "OFT1:MIS1"))
...
C<-ggplot(plot.dat2, 
	...
	breaks = c("traitOFT1:sexM",  "traitOFT1:age", "traitOFT1:age2", "traitOFT1:local.density", "traitOFT1:avg_fam", "traitOFT1:date"),
			labels = c("Sex", "Age",expression("Age"^2), "Julian date", "Density", "Familiarity")) +
...
#MIS1 plot only
plot.dat2<-plot.dat%>%filter(subject %in% c("traitMIS1:sexM",  "traitMIS1:age", "traitMIS1:age2", "traitMIS1:local.density", "traitMIS1:avg_fam", "traitMIS1:date"))

plot.dat2$subject2 <- factor(plot.dat2$subject2, levels=c("traitMIS1:sexM",  "traitMIS1:age", "traitMIS1:age2", "traitMIS1:local.density", "traitMIS1:avg_fam", "traitMIS1:date"))
...
D<-ggplot(plot.dat2, 
	...
	scale_y_discrete(
	breaks = c("traitMIS1:sexM",  "traitMIS1:age", "traitMIS1:age2", "traitMIS1:local.density", "traitMIS1:avg_fam", "traitMIS1:date"),
			labels = c("Sex", "Age",expression("Age"^2), "Julian date", "Density", "Familiarity")) +

...
(yearling_axy_all) %>% as_tibble() %>% dplyr::count(squirrel_id) %>% nrow() #68 individuals
(yearling_axy_all) %>% as_tibble() %>% dplyr::count(squirrel_id, axy_yr, axy_month) %>% nrow() #~95 sessions
nrow(yearling_axy_all) #3924
